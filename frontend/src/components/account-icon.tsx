...
import { Building2, PiggyBank, CreditCard, TrendingUp, Wallet, Landmark } from 'lucide-react'
...
> = {
  ...
  loan:        { icon: Landmark,    color: 'text-orange-600',  bg: 'bg-orange-100',  label: 'accounts.typeLoan' },
